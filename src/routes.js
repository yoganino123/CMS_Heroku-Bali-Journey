...
const routes = [
  ...
  { path: '/admin/destination', name: 'Destination', element: Destination },
  { path: '/admin/package-trip', name: 'PackageTrip', element: PackageTrip },
  { path: '/admin/review/destination', name: 'ReviewDestination', element: ReviewDestination },
  { path: '/admin/review/package-trip', name: 'ReviewPackageTrip', element: ReviewPackageTrip },
